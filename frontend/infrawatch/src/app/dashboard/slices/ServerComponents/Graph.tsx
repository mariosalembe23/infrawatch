  ...
  return (
    <section className="relative h-full">
      <header>
        ...
        <div className="mt-10 pb-5 flex items-center justify-start gap-2">
          <Button
            variant={"outline"}
      ...
      {isEmpty(server?.last_metrics || {}) ? (
        <div className="max-w-xl mt-10 w-full">
          <p className="text-zinc-400 font-[420]">
            Nenhum dado de métrica disponível para este servidor. Por favor,
            instale o agente e configure as métricas para começar a monitorar.
          </p>
          <Button
            variant={"outline"}
            onClick={() => setShowMetricConfig(true)}
            className="dark:border-zinc-900 mt-4 dark:hover:bg-zinc-800/20"
          >
            Guia de instalação
            <BookOpen size={16} className="dark:text-zinc-400 text-zinc-600" />
          </Button>
        </div>
      ) : (
        <div className="grid grid-cols-1 gap-4">
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="grid ret:grid-cols-2 pot:items-stretch items-start lal:grid-cols-3 grid-cols-1 gap-3">
              ...
              <div className="pot:col-span-2 lal:order-4 order-3  grid grid-cols-1 pot:grid-cols-2 gap-3">
                <div className="dark:bg-zinc-950 flex flex-col  justify-between p-5  border dark:border-zinc-900/40 rounded-2xl">
                  ...
                  <footer className="flex pt-4 items-center justify-start gap-4 flex-wrap">
                    <p className=" flex text-[15px] items-center gap-2">
                      Dados Enviados{" "}
