        ...
        <div className="flex w-full h-full items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-zinc-600">
              {device.sys_name} / {device.device_name}
            </p>
            <p className="flex items-center justify-center gap-2">
              Sincronizando
              <span className="loader !w-3 !h-3 !border-zinc-600 !border-2 !border-b-white"></span>
            </p>
          </div>
        </div>
      ) : (
            ...
            <div className="flex w-full flex-col gap-2">
              ...
              <div className="flex items-center w-full justify-between">
                ...
                <p className="dark:text-white text-[14px]">
                  {!isEmpty(device?.last_device) &&
                    removeDoubleSlashes(device.last_device.uptime).slice(
                      3
                    )}{" "}
                  -{" "}
                </p>
